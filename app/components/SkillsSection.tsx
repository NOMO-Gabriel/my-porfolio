...
export default function SkillsSection() {
    ...
    const skillsContent = {
        en: [
            ...
            { title: 'Mobile Development', description: 'Amator     in developing mobile applications for iOS and Android platforms using Flutter and React Native.' },
        ...
        fr: [
            ...
            { title: 'Applications Desktop', description: 'Compéptences dans la création d\'applications desktop multiplateformes avec des technologies comme Electron et Java.' }
        ]
    };
